...
<template>
  <div class="map">
    <svg version="1.1" xml="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    viewBox="0 0 1423 1897" enable-background="new 0 0 1423 1897" xml:space="preserve">
      <g>
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('64')}" id="64" :class="selectedCity === '64' ? 'active' : ''" d="M915.3,703.5c-21.9,13.8-55.1-4.4-78.1,12.2c-0.1,0.1-0.2,0.1-0.3,0.2
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('15')}" id="15" :class="selectedCity === '15' ? 'active' : ''" d="M952.9,958.8c34.5-11.6,68.6-23.1,102.9-34.3c45.3-0.1,50.8-4.1,47-50.3
          c-1-59.6,7.8-54.7-32.2-96.7c49.4-221.9-76,15.6-115.3,75.5C971.3,877,934.7,961.5,952.9,958.8z"/>
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('41')}" id="41" :class="selectedCity === '41' ? 'active' : ''" d="M1254.7,861.1c-2.3-0.8-4.7-1.5-7-2.2c-2.2-0.7-3.8-2.8-3.8-5.2c0-6.3-6.1-13.1-5.8-19.8
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('26')}" id="26" :class="selectedCity === '26' ? 'active' : ''" d="M1238.1,675.5c-58.2,17.2-47.2,49.4-0.7,78c1.7-6.6,9.1-9.3,11.4-0.9
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('67')}" id="67" :class="selectedCity === '67' ? 'active' : ''" d="M768.5,747.1c-25.5,39.3-53.9,17.9-50.8,53.9c2.1,11.5-10.3,37.9,4.4,39.8
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('02')}" id="02" :class="selectedCity === '02' ? 'active' : ''" d="M938.8,968.3c-17.4-7.2-31.7-18.2-49.7-18.9c-21.7-8-58.9-33.1-56,5.2
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('08')}" id="08" :class="selectedCity === '08' ? 'active' : ''" d="M1132,956.2c3.1-10-5.9-13.2-11.4-17.8c-4.5-0.6-6-5-7.5-8c-5.2-8.1-19-1.7-27.4-2.4
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('58')}" id="58" :class="selectedCity === '58' ? 'active' : ''" d="M1052,1076c-22.9,9-52.7-30-80.9-24.7c0,0-8.8-0.5-13.5-0.8c-1.8-0.1-3.6,0.4-5.2,1.3
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('27')}" id="27" :class="selectedCity === '27' ? 'active' : ''" d="M586.4,1052c-11.7-32.2-33.7-73.8-4.2-106.4c-5.9-2.6-6,6.7-10.7,8.9c1.1,4.1-1.5,6.2-3.8,9.8
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('45')}" id="45" :class="selectedCity === '45' ? 'active' : ''" d="M472,1077.8c10.2,3.9,18.4,13.5,27.5,17.8c11.5-0.8,15,11.9,17.9,20.3c6.2,2.4,14,9.3,9.7,17.4
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('65')}" id="65" :class="selectedCity === '65' ? 'active' : ''" d="M863.8,1078.3c-10.2-16.4-30.5-4.1-42.9-15.8c-34.9-25.2-5.7,4.5-19.1,12.7
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('46')}" id="46" :class="selectedCity === '46' ? 'active' : ''" d="M600.1,1180.7c8,8.6,22.2,13.1,33.8,13.6c34.3,13.2,33.9-28.5,23.4-51.9
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('54')}" id="54" :class="selectedCity === '54' ? 'active' : ''" d="M716.4,1200.6c-5.2-13.6-9.4-27.5-14.4-41.1c6.1-2.5,13.5,1,18.5-3.4c6.4-7.1,14.1,1.8,8.6-10.3
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('12')}" id="12" :class="selectedCity === '12' ? 'active' : ''" d="M302,993.9c2.1-4.4,7.7-2.2,11.2-1.1c0.5,0.2,1,0.2,1.4,0.2c9.8-0.7-4.5-10.3,2.8-15.3
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('53')}" id="53" :class="selectedCity === '53' ? 'active' : ''" d="M463.5,1054c1.9-3.8,11.5-3.4,15.3-1.6c0.5,1.7,0.6,7.5,2,7.3c4.3,2.2,9.7,2.3,14.3,4.3
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('21')}" id="21" :class="selectedCity === '21' ? 'active' : ''" d="M439.5,1034.6l0-6.2c0-0.7,0.9-1.1,1.4-0.6c5.9,5.6,10.6-18.1,15.7-21.3
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('42')}" id="42" :class="selectedCity === '42' ? 'active' : ''" d="M1056.6,1268.8c-1,1.3-3.4-0.2-3.5-0.3c-20.4-10.2-41.9-31.5-65.6-23.5
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('25')}" id="25" :class="selectedCity === '25' ? 'active' : ''" d="M640.1,1220.9c12.8-36.6-13.9-7.5-43.5-34.7c-9.3,5.5-9.1,17.7-7.1,28.5c1.4,4.7-2.5,2-5,4.4
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('17')}" id="17" :class="selectedCity === '17' ? 'active' : ''" d="M800.9,1321.9c-4.3-38.4-34.4-115.3-80.2-104c-27.5,5.5-23.6-5.9-26.9,21.4
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('55')}" id="55" :class="selectedCity === '55' ? 'active' : ''" d="M492.9,1316.2c20.9-4.7-9.8-36,17.5-34.6c4.2-7.4,0.7-18.2,3.5-26.3c5.2-3.4,10.2,2.2,17.9-1.3
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('10')}" id="10" :class="selectedCity === '10' ? 'active' : ''" d="M895.3,1360c0-5.1,0-13.4,0-17c0-1.1,0.4-2.2,1-3.1c9.4-13.1,18.3-27.2,28.3-39.8
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('07')}" id="07" :class="selectedCity === '07' ? 'active' : ''" d="M515.5,1442.6c-0.4-2.3,0.5-2.9,2.5-2.9c37.2-16.4,1.1-23.2,17.3-33.5c-3.9-5.1-5.8-7.7-12.6-9.3
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('66')}" id="66" :class="selectedCity === '66' ? 'active' : ''" d="M554.2,1446.5c8.8-25.7,19.3-45,46-58.3c6.4-2.4,18.2-18.1,8-22.3
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('62')}" id="62" :class="selectedCity === '62' ? 'active' : ''" d="M705.5,1334.4c-5.2,4.1-8.1,15-15.4,4.9c-8.9,21.6-24.4,9.9-35.3-3.8
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('40')}" id="40" :class="selectedCity === '40' ? 'active' : ''" d="M255.5,831.6c8-2.3,13-11.3,21.8-11c0.1,0,0.1,0,0.2,0c8.9-1,35.8-0.4,24.4-13.4
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('56')}" id="56" :class="selectedCity === '56' ? 'active' : ''" d="M271.4,919.4c11.1-0.9,2.3,1.6,5.7,3.5c5.1-2.8,9.5,1.9,14.1,1.9c5.5,1,4.4,6.4,10.7,3.8
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('16')}" id="16" :class="selectedCity === '16' ? 'active' : ''" d="M388.3,770c3.9,9.3,0.6,19.5,9.2,25.1c0.4,0.3,0.8,0.8,0.8,1.3c0.8,10.1-2.4,19.8-4.6,29.9
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('06')}" id="06" :class="selectedCity === '06' ? 'active' : ''" d="M312.2,824.2c7.4,1.5,12.9,6.4,17.9,11.7c0.1,0.1,0.2,0.2,0.3,0.2c3.1,1.6,2.2,8.1,6.3,6.7
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('63')}" id="63" :class="selectedCity === '63' ? 'active' : ''" d="M491.8,855c-9.8-1.1-6.5,3-9.9,4.3c-0.6,0.2-1,0.9-0.8,1.6c0.9,2.5-6.6,2.9-9.6,1.9
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('28')}" id="28" :class="selectedCity === '28' ? 'active' : ''" d="M240.2,739.5c4.7-4.5,13-3.5,17-8.7c5.6,2.1,12.2-2.3,17.9-3.9c0.4-0.1,0.7-0.1,1.1-0.1
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('14')}" id="14" :class="selectedCity === '14' ? 'active' : ''" d="M292.2,616.4c42.3,66.7,4.1,46.4,9.5,84.9c5.4,5.6,7.1,15.3,9.5,21.8
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('29')}" id="29" :class="selectedCity === '29' ? 'active' : ''" d="M431.3,505.3c-18.8,10.7-81.3,20.6-55.9,48.5c7.7,1.9,8.5,8.5,12.1,14.1
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('04')}" id="04" :class="selectedCity === '04' ? 'active' : ''" d="M733,656.7c-5.6-0.1-13,0.6-13.5-6.7c-1.1-5.3-12-0.2-12.7-8c-53.7,8.3-29.3,80.6-76,94.5
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('09')}" id="09" :class="selectedCity === '09' ? 'active' : ''" d="M651.8,696.3c10.3,12,6.9-38.8,24.8-44.4c9.4-6.8,21.9-11.6,28.9-20.8c4.8-11.1-4.2-7.9-7.6-17.7
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('51')}" id="51" :class="selectedCity === '51' ? 'active' : ''" d="M515.2,537.4c3.1,7.8,10.6,7.1,15.3,12.4c-0.2,13.5,1.8,25.8,11.8,34.8c7.2,6.9,10.6,18,12.1,28
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('52')}" id="52" :class="selectedCity === '52' ? 'active' : ''" d="M478.9,669.4c4.5,3-0.4,18.7,6,20c7.6,0.3,4.2,12.8,11.9,8.7c8.6,2.4,16.3,13.2,25.4,11.9
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('05')}" id="05" :class="selectedCity === '05' ? 'active' : ''" d="M467.4,735.8c7.1,7.3,15,12.2,24.4,15.7c-3.7,2,3.3,2.8,3.5,7.4c7.5-10.8,27,17.9,21-7.5
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('60')}" id="60" :class="selectedCity === '60' ? 'active' : ''" d="M810.3,563.4c-5.3-1.3-7.7,3.6-13.1,4c-6.2,0.5-1.1,8.4-3.7,12.4c-0.6,3.1-6.1,7.2-12.1,12.8
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('20')}" id="20" :class="selectedCity === '20' ? 'active' : ''" d="M727.5,577.7c-1.2,0.7-1.8-6.5-6-4.5c-0.7,0.4-1.6,0.3-2.4-0.1c-2.1-1-5.7-1-7,0.7
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('49')}" id="49" :class="selectedCity === '49' ? 'active' : ''" d="M842.7,474.4c-2.1,6.3-4.8,14.1-3.9,19c0.2,1,0.8,1.9,1.6,2.6c10.5,8.5,19.1,19.2,24.8,31.2
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('57')}" id="57" :class="selectedCity === '57' ? 'active' : ''" d="M500.6,408.3c6.7,0.7,16.8-7.6,21.3-2.8c9,4.1,23.7,2.1,33.6,0.7c8.2-11.8,7.4-33.5,26-37.3
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('11')}" id="11" :class="selectedCity === '11' ? 'active' : ''" d="M559.9,524.1c18.5,0.9,35.9,11.5,53.4,13.9c3.2-0.6,8.9-3.2,11.1,0.8c7.2-5.7,5.5-22.8,8.6-32.4
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('59')}" id="59" :class="selectedCity === '59' ? 'active' : ''" d="M553.3,532c-1.5,17.3,9.1,38.3,14.4,55.1c16.8,10.5,9.7,3.5,29.3-9.8c17.7-5,33.9,14.3,45.9-8.7
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('18')}" id="18" :class="selectedCity === '18' ? 'active' : ''" d="M761.4,446.5c-9.2-3.2-19.2-4.8-28.4-7.3c-10,1.8-18.8,5.5-26.5-3.5c-1.6-1.3-3.8-2.4-5-4.1
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('01')}" id="01" :class="selectedCity === '01' ? 'active' : ''" d="M601.6,470c12.4,4.9,25.3,0.6,38.5,4.2c12.1-4.3,12.5-38.2,2.6-48.3
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('13')}" id="13" :class="selectedCity === '13' ? 'active' : ''" d="M559,445.6c10.5,11.5,24.8,7,15.4,25.4c-0.3,0.5,0.2,1.1,0.8,1c11.8-2.9,11.6-17.6,21.2-23.1
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('22')}" id="22" :class="selectedCity === '22' ? 'active' : ''" d="M553.9,302.1c11.5,43.1,31.4,37.4,61.8,14.5c13.1,16.5,17.6,2.7,35,2.7
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('44')}" id="44" :class="selectedCity === '44' ? 'active' : ''" d="M596,352.7c62.9,21.6,47-0.4,50.2,65.8c9-17.7,19.2,1.8,27.4,3.3c15.6,1.5,6.7,2,1.8-9.7
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('19')}" id="19" :class="selectedCity === '19' ? 'active' : ''" d="M695.5,479.5c-7.7,2.6-3.2,11.5-11.5,12.6c-0.4,0.8-1.1,1-1,2.1c0.2,5.6-10.9,9.3-8,16.3
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('50')}" id="50" :class="selectedCity === '50' ? 'active' : ''" d="M633.5,545c2.4,12.8,14,17.7,22.8,19.9c-0.9-5.6-4.2-15.3-7.9-15c-2.1,0.2-4-1.3-4.5-3.4
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('47')}" id="47" :class="selectedCity === '47' ? 'active' : ''" d="M443.8,492.3c7.6,4.1,9.2,1.1,15-2.2c12.3,7.5,11.1,28.1,30.7,37.6c19,0.4,36.5-11.2,56-6.5
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('61')}" id="61" :class="selectedCity === '61' ? 'active' : ''" d="M820.1,494.2c-19.2,13.6-28.2,9.6-48.1,3.5c-7.4,6.4-2.7,18.8-9.9,26.4
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('03')}" id="03" :class="selectedCity === '03' ? 'active' : ''" d="M794.1,366.7c0,0.1,0.1,0.2,0.1,0.3c-0.2,6.7,5.8,23.3-4.6,23.7c-1.8,0.3,0,2.8-1,3.2
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('43')}" id="43" :class="selectedCity === '43' ? 'active' : ''" d="M756.3,302.7c0,3.1-0.8,3.4-3.6,2.5c-1.1,0.6-2,2-4.4,2.1c-14.1,0.4-8.4,22.3-9.3,33.1
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('23')}" id="23" :class="selectedCity === '23' ? 'active' : ''" d="M457.2,1646.8c-14.2-9.9-2.5-33.6-10.9-36.4c-0.8-0.3-1.3-1.2-1.1-2.1c0.7-5.6-6.9-9.7-10-15.5
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('24')}" id="24" :class="selectedCity === '24' ? 'active' : ''" d="M421.4,1563.7c8.6,11.1,16.7,21.5,23.9,32.7c3.5,1,4.7,5.8,6.1,8.5c1.1,1.9,4.4,2.1,4,6.6
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('30')}" id="30" :class="selectedCity === '30' ? 'active' : ''" d="M332.4,547.8c4.5-1,9.5-0.5,13.8-1.8c0.2-3.6,4.7-3.6,7.8-3.7c2.8-0.6,7.4,5,7.4,0.1
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('48')}" id="48" :class="selectedCity === '48' ? 'active' : ''" d="M505.1,283c17.8-17.5,8.9-8.8,17.4-3.5c0.2,0.1,0.4,0.2,0.6,0.2c21.1,3.9,15.8-8.7,22.8-22.1
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('35')}" id="35" :class="selectedCity === '35' ? 'active' : ''" d="M572.5,942.7c6.8-8,25.9,3.3,27.9-14.5c2.7-20.9,25.5-31.8,22.3-53
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('32')}" id="32" :class="selectedCity === '32' ? 'active' : ''" d="M651.3,887.9c-1.4-4.5,3.5-18.1-2.3-16.8c-1.5,13.5-23.9-0.1-20.7,13.6
          c-2,18.6-22.1,29.6-24.8,52.8c-31.5,15.8-36.3,54.8-23,83.9c10.4,14,12.9-35,28.1-43.9C623.5,947.6,650.6,920.3,651.3,887.9z"/>
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('37')}" id="37" :class="selectedCity === '37' ? 'active' : ''" d="M629.1,1113.8c37.4,28.2,12.7-8.1,14.5-33.2c0.5-7.5,27.6-1.9,35.9-4
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('38')}" id="38" :class="selectedCity === '38' ? 'active' : ''" d="M796.7,1034.2c9.5-29.9,29-57-18-57.2c-24.2-6.8-67.1-53.2-64.7-2.7
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('33')}" id="33" :class="selectedCity === '33' ? 'active' : ''" d="M657.4,884.4c-3.8,34.2-1.1,24.8,26.8,39.9c31.1,15.7,60.2,28.3,93.3,43.9
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('36')}" id="36" :class="selectedCity === '36' ? 'active' : ''" d="M704.2,778c-38.3,7.8-48,56-46.5,89.6c4.4,23.1,62,3.5,84.9,9.4c-5.2-12.7-21.9-16.8-24.8-30.9
          c-13.8-1.1-7.6-11.6-7.9-21.2C707,819.8,722.5,769.2,704.2,778z"/>
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('34')}" id="34" :class="selectedCity === '34' ? 'active' : ''" d="M565.2,807c-6.8,13.7-0.1,22.2,7,33.4c9.7,6.2,28.3-11.6,41.7-10.7c12.5,1.1,28-8.7,38.1,0.9
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('39')}" id="39" :class="selectedCity === '39' ? 'active' : ''" d="M510.1,874.6c12,1.5,29.5,1.9,35.3,13.9c11.1,9.7,17.1,10.5,12.8-5.4
        ...
        <path @click="selectCity" :style="{'--color-opacity': colorOpacity('31')}" id="31" :class="selectedCity === '31' ? 'active' : ''" d="M630.6,872c19,1.8,5.9-4.3,21.3-8.2c6.3-30-8.5-34.8-35.6-28.4c-10,3-53.8,10.6-34.1,22
...
export default {
  ...
  methods: {
    ...
    colorOpacity(cityId) {
      const city = this.$store.getters.getCityById(cityId);
      return city.color_opacity;
    },
  },
  computed: {
    selectedCity() {
...
<style scoped lang="scss">
  ...
  path {
    fill: rgba($color: #ce3939, $alpha: var(--color-opacity))
  }
