...
<template>
  <div class="map">
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      ...
      <path @click="selectCity" id="02" :class="selectedCity === '02' ? 'path active' : 'path'" fill="#A46475" d="M234.2,273.2c-5.5-2.2-10-5.7-15.6-5.9c-6.8-2.5-18.5-10.4-17.6,1.6c-2.6,9.6-9.5,18.5-9.3,28.4
      ...
      <path @click="selectCity" id="07" :class="selectedCity === '07' ? 'path active' : 'path'" fill="#266992" d="M101.2,422.2c-0.1-0.7,0.1-0.9,0.8-0.9c11.7-5.2,0.3-7.3,5.4-10.5c-1.2-1.6-1.8-2.4-4-2.9
      ...
      <path @click="selectCity" id="06" :class="selectedCity === '06' ? 'path active' : 'path'" fill="#606787" d="M37.3,227.9c2.3,0.5,4.1,2,5.6,3.7c0,0,0.1,0.1,0.1,0.1c1,0.5,0.7,2.5,2,2.1
      ...
      <path @click="selectCity" id="04" :class="selectedCity === '04' ? 'path active' : 'path'" fill="#7B6681" d="M169.8,175.3c-0.1,0-0.2,0-0.3,0c-1.7,0-4,0.1-4.1-2.1c-0.3-1.5-3-0.4-3.8-1.8
      ...
      <path @click="selectCity" id="09" :class="selectedCity === '09' ? 'path active' : 'path'" fill="#51688A" d="M144,187.7c3.3,3.8,2.2-12.2,7.8-13.9c3-2.1,6.9-3.6,9.1-6.5c1.5-3.5-1.3-2.5-2.4-5.6
      ...
      <path @click="selectCity" id="05" :class="selectedCity === '05' ? 'path active' : 'path'" fill="#91657B" d="M86.1,200.1c2.2,2.3,4.7,3.8,7.7,4.9c-1.2,0.6,1,0.9,1.1,2.3c2.4-3.4,8.5,5.6,6.6-2.4
      ...
      <path @click="selectCity" id="01" :class="selectedCity === '01' ? 'path active' : 'path'" fill="#956579" d="M128.2,116.6c3.9,1.5,8,0.2,12.1,1.3c3.8-1.4,3.9-12,0.8-15.2c-4.3-5.3,3.5-15.5-3.7-18
      ...
      <path @click="selectCity" id="03" :class="selectedCity === '03' ? 'path active' : 'path'" fill="#1A6993" d="M188.7,84.2C188.7,84.2,188.7,84.3,188.7,84.2c0,2.2,1.9,7.4-1.4,7.5c-0.6,0.1,0,0.9-0.3,1
